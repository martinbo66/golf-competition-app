...
class OrganizationSubResourceApiIntegrationTest {
    ...
    void players_fullCrudUnderOrg() throws Exception {
        ...
        CreatePlayerRequest createReq = new CreatePlayerRequest(
            "Alice Fairway", null, TalentRating.B, new BigDecimal("50.00"));
        ...
        UpdatePlayerRequest updateReq = new UpdatePlayerRequest(
            "Alice Updated", null, TalentRating.B, new BigDecimal("50.00"));
    ...
    void players_returns404WhenCompetitionBelongsToDifferentOrg() throws Exception {
        ...
        CreatePlayerRequest req = new CreatePlayerRequest("Bob Bogey", null, TalentRating.C, null);
        mockMvc.perform(
    ...
    void teams_createAndGenerateUnderOrg() throws Exception {
        ...
        CreatePlayerRequest playerA = new CreatePlayerRequest("Player A", null, TalentRating.A, null);
        CreatePlayerRequest playerB = new CreatePlayerRequest("Player B", null, TalentRating.B, null);
        CreatePlayerRequest playerC = new CreatePlayerRequest("Player C", null, TalentRating.C, null);
        CreatePlayerRequest playerD = new CreatePlayerRequest("Player D", null, TalentRating.D, null);
